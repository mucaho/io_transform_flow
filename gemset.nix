{
  ...
  parlour = {
    dependencies = ["commander" "parser" "rainbow" "sorbet-runtime"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0wczqyzbybhps3jby356f98rjs1598xnsgzga2dv8s302xd61vsn";
      type = "gem";
    };
    version = "5.0.0";
  };
  ...
  sorbet-runtime = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "10aw7bc4566bhy0kjd7p8qkb39dp7cz4q0wscwzww2a01nga8mhi";
      type = "gem";
    };
    version = "0.5.10398";
  };
  sord = {
    dependencies = ["commander" "parlour" "sorbet-runtime" "yard"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1fd461396z0m086xdvnzrzjg6bi4ghqrh44cx11ds1l39jcxzmn0";
      type = "gem";
    };
    version = "4.0.0";
  };
  ...
  yard-junk = {
    dependencies = ["backports" "rainbow" "yard"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "01gsa704p2x212vjn86bc6wa32xv0kfpjzy8sba05psj7gbfygy3";
      type = "gem";
    };
    version = "0.0.9";
  };
